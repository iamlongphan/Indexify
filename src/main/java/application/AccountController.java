...
public class AccountController {
    ...
    public void cancelButton() {
        try {
            Parent root = FXMLLoader.load(Main.class.getResource("courseViewer.fxml"));
    ...
    /**
     * Validates whether an account exists
     *
     * @param oldpassw The old password
    ...
    public boolean validatespass(String oldpassw) throws FileNotFoundException {
        ...
        while (readDatabase.hasNextLine()) {
            ...
            realOldPass = passUtil.decrypt(realOldPass);
    ...
    public void changePass() throws IOException {
        ...
        if (validatespass(oldPassword)) {
            ...
            PassUtil passUtil = new PassUtil();
            newPassword = passUtil.encrypt(newPassword);
     ...
     *
     * @param courseToRemove input a String name of the course we wish to remove
     */
     ...
     *
     * @throws FileNotFoundException in case file no found
     */
     ...
     * @param file Delete file with said file name
     */
